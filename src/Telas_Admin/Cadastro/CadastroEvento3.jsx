...
function CadastroEvento3() {
  ...
  const {tituloEvento,descricao,data,hora,tipoEvento,cep,street,number, prioridade} = eventoData2
          ...
          <tbody>
            {ingressosAdicionados.map((ingresso, index) => (
              <tr key={index}>
                ...
                <td>
                 <button className="th-buttton" onClick={() => handleDeleteTicket(index)}></button>
                </td>
              </tr>
            ))}
          </tbody>
